...
var Slider = function (_Component) {
  ...
  function Slider(props, context) {
    ...
    _this.coordinates = function (pos, value2) {
      ...
      var position = _this.getPositionFromValue(value2);
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      var coords = this.coordinates(position, value);
      ...
      var handleDrag = this.props.disabled ? undefined : this.handleDrag;
      var handleStart = this.props.disabled ? undefined : this.handleStart;
      var handleEnd = this.props.disabled ? undefined : this.handleEnd;
      var handleKeyDown = this.props.disabled ? undefined : this.handleKeyDown;
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          className: (0, _classnames2.default)('rangeslider', 'rangeslider-' + orientation, { 'rangeslider-reverse': reverse,
            'rangeslider-disabled': this.props.disabled }, className),
          onMouseDown: handleDrag,
          onMouseUp: handleEnd,
          onTouchStart: handleStart,
          onTouchEnd: handleEnd,
